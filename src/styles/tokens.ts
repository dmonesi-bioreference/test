...
const tokens = {
  ...
  colorSecondaryText: colors.coolGray[600],
...
export const inputs = {
  ...
  color: colors.black,
  disabledBackgroundColor: colors.coolGray[100],
  disabledColor: colors.coolGray[800],
