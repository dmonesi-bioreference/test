            ...
            list: [
              {
                ...
                content:
                  ...
                  '<ul><li>Personal or "individually identifiable" information you provide to us.</li><li>Aggregate information regarding overall website traffic patterns.</li></ul>' +
      ...
      forms: {
        consent: {
          ...
          description:
            ...
            '</ul>' +
            '<h7>The scope of your right to request an accounting may be modified from time to time to comply with changes in federal law or state law.</h7>' +
            '<h7>Ordinarily we will respond to your request for an accounting within 60 days. If we need additional time to prepare the accounting you have requested, we will notify you in writing about the reason for the delay and the date when you can expect to receive the accounting. In rare cases, we may have to delay providing you with the accounting without notifying you because a law enforcement official or government agency has asked us to do so.</h7>',
          agreement: {
            consent: {
        ...
        results: {
          timeline: {
            ...
            waiting: {
              ...
              body: "We're working on processing your DNA sample. You can check out these resources while you're waiting.",
