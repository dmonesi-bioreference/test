...
import { Card, PageLayout, Typography, Toggle, Divider } from 'components';
      ...
      <DataSharingSetting>
        <div className="data-sharing-settings--heading-container">
          <Typography type="heading" level="2" alignment="center">
            {' '}
            {t('sections.dataSharingSettings.headData')}
          </Typography>
        </div>
        <Divider />
        ...
        <div className="data-sharing-settings--section-heading">
          <Typography type="label" labelType="display">
            {t('sections.dataSharingSettings.dataSharingHeadingOne')}
          </Typography>
        </div>
        <Card>
          <DataSettingsRow
            title={t('sections.dataSharingSettings.titleOne')}
            content={t('sections.dataSharingSettings.content')}
            isLast={false}
          />
          <DataSettingsRow
            title={t('sections.dataSharingSettings.titleTwo')}
            content={t('sections.dataSharingSettings.content')}
            isLast={false}
          />
          <DataSettingsRow
            title={t('sections.dataSharingSettings.titleThree')}
            content={t('sections.dataSharingSettings.content')}
            isLast={true}
          />
        </Card>
        <div
          className="data-sharing-settings--section-heading"
          style={{
            marginTop: tokens.spacingXLarge,
            marginBottom: tokens.spacingXSmall,
          }}
        >
          <Typography type="label" labelType="display">
            {t('sections.dataSharingSettings.titleSix')}
          </Typography>
        </div>
        <Card>
          <DataSettingsRow
            title={t('sections.dataSharingSettings.titleFour')}
            content={t('sections.dataSharingSettings.content')}
            isLast={false}
          />
          <DataSettingsRow
            title={t('sections.dataSharingSettings.titleFive')}
            content={t('sections.dataSharingSettings.content')}
            isLast={true}
          />
        </Card>
