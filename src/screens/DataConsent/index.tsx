...
export const DataConsent = () => {
  ...
  const Preview: React.FC = (props) => {
    return (
     <div className="data__preview-card">
       {props.children}
       </div>
    )
  }
  return (
   ...
   <div style={{ marginBottom: tokens.spacingXSmall}}>
     <Preview >
     <Typography type="label"  labelType='display'>{t('sections.dataConsent.resources')}</Typography>
    ...
    <Preview > 
          <Typography type="label"  labelType='display'>{t('sections.dataConsent.similar')}</Typography>
        ...
        <div 
         ...
         >
        <Typography type="heading"  level= '2' alignment="center">{t('sections.dataConsent.child')}</Typography>
        </div>
        <Typography type="body" alignment="center" >
          {t('sections.dataConsent.para')}</Typography>
        <div style={{ margin: `${tokens.spacingXLarge} 0`, textAlign:'center' }}>
        <RadioGroup onChange={handleChange} value={value} name="radio">
      <Radio value={t('sections.dataConsent.yes')} label= {t('sections.dataConsent.yes')} />
      <Radio value={t('sections.dataConsent.no')}  label={t('sections.dataConsent.no')} />
    </RadioGroup>
    </div>
          ...
          <Typography type='helper-text' color="minor" alignment='center'> {t('sections.dataConsent.footer')}</Typography>
          </div>
          </Card>
          </DataConsentStyledDiv>
    </PageLayout> 
