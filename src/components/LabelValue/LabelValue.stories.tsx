...
export const reverseStory = () => (
  <LabelValue label="Phone Number" value="555-555-5555" reverse={true} />
);
...
export const horizontalReverse = () => (
  <LabelValue label="Phone Number" value="555-555-5555" reverse={true} orientation="horizontal" />
);
