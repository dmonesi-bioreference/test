...
const tokens = {
  ...
  colorPrimary: colors.yellow[400],
  colorPrimaryHover: colors.yellow[500],
  colorPrimaryText: colors.yellow[900],
  colorSecondary: colors.blueGray[200],
  colorSecondaryHover: colors.blueGray[300],
  ...
  colorBlackSecondary: rgba(colors.black, 0.6),
