...
const tokens = {
  ...
  colorPrimary: colors.blueGray[600],
  colorPrimaryHover: colors.blueGray[700],
  colorSecondary: colors.lightBlue[800],
  colorSecondaryHover: colors.lightBlue[900],
  ...
  colorBorderInput: colors.blueGray[250],
  ...
  // Shadow
  shadowSubtle: `0 2px 4px 0 ${colors.gray[200]}`,
  shadowSmall: `0 2px 1px 0 ${colors.gray[250]}`,
  shadowHover: `0 2px 3px 1px ${colors.gray[250]}`,
  shadowMedium: `0 4px 8px 0 ${colors.gray[250]}`,
  shadowLarge: `0 8px 16px 0 ${colors.gray[250]}`,
  shadowBig: `0 16px 24px 0 ${colors.gray[250]}`,
  shadowDeep: `0 24px 32px 0 ${colors.gray[250]}`,
  shadowLeft: `-4px 0 12px 0 ${colors.gray[250]}`,
  shadowInsertSubtle: `inset 0 1px 1px ${colors.gray[200]}`,
  // Time
  durationQuickly: '.1s',
